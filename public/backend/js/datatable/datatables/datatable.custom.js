(function ($) {
  $(document).ready(function () {
    ...
    $("#data-source-4").DataTable({
      ...
      ajax: "/backend/json/server-side.json",
    });
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: "/backend/ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: "/backend/ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "/backend/ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "/backend/ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
