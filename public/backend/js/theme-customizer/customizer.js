...
/**==COLOR_PICKER==**/
  $(document).ready(function () {
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", "/backend/css/" + color + ".css");
